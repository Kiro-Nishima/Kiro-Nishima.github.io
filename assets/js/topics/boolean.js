...
backTopBtn.addEventListener("click", scrollToTop);
  ...
  const questions = [
    {
        question: "Which of the following operations are fundamental in Boolean algebra?",
        answers: [
            {text: "A) Addition, Subtraction, Multiplication" ,correct: false},
            {text: "B) Conjunction, Disjunction, Negation" ,correct: true},
            {text: "C) Integration, Differentiation, Summation" ,correct: false},
            {text: "D) Union, Intersection, Complement" ,correct: false},
        ]
    },
    {
        question: "In Boolean algebra, the identity element for the AND operation (∧) is:",
        answers: [
    ...
    {
        question: "What is the result of the Boolean expression A ∨ 0?",
        answers: [
            {text: "A) 0" ,correct: false},
    ...
    {
        question: "Which of the following Boolean expressions represents De Morgan's law?",
        answers: [
            {text: "A) ¬(A∧B = ¬A∨¬B" ,correct: false},
            {text: "B) ¬(A∨B = ¬A∧¬B" ,correct: false},
            {text: "C) Both A and B" ,correct: true},
            {text: "D) Neither A nor B" ,correct: false},
        ]
    },
    {
        question: "If A is true and B is false, what is the truth value of A ∧ (¬B)?",
        answers: [
