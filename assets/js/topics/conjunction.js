...
backTopBtn.addEventListener("click", scrollToTop);
  ...
  const questions = [
    {
        question: "Which of the following symbols represents conjunction?",
        answers: [
    ...
    {
        question: "The conjunction of two statements, P and Q, is true if",
        answers: [
            {text: "A) Both P and Q are true." ,correct: true},
            {text: "B) Either P or Q is true, or both are true." ,correct: false},
    ...
    },
    {
        ...
        answers: [
            ...
            {text: "C) It is sunny or it is raining." ,correct: false},
            {text: "D) It is raining and it is windy." ,correct: true},
        ]
    },
    {
        question: "Given the statements P: \"It is raining\" and Q: \"It is windy\", which of the following represents the conjunction of P and Q?",
        answers: [
    ...
    {
        question: "If P is false and Q is true, what is the truth value of the conjunction P∧Q?",
        answers: [
