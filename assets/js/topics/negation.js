...
backTopBtn.addEventListener("click", scrollToTop);
  ...
  const questions = [
    {
        question: "Which of the following symbols represents negation?",
        answers: [
    ...
    {
        question: "The negation of a statement PPP is true if:",
        answers: [
            {text: "A) P is true." ,correct: false},
            {text: "B) P is false." ,correct: true},
            {text: "C) P is both true and false." ,correct: false},
            {text: "D) None of the above." ,correct: false},
        ]
    },
    {
        question: "Which of the following is an example of negation?",
        answers: [
            {text: "A) It is sunny and it is raining. " ,correct: false},
            {text: "B) It is not raining." ,correct: true},
            {text: "C) If it rains, then the ground is wet." ,correct: false},
            {text: "D) The ground is wet if and only if it rains." ,correct: false},
        ]
    },
    {
        question: "Given the statement P: \"It is raining\", which of the following represents the negation of P?",
        answers: [
    ...
    {
        question: "If P is false, what is the truth value of the negation ¬P?",
        answers: [
